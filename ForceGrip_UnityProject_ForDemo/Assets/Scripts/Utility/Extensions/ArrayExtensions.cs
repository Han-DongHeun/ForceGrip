...
public static class ArrayExtensions
{
	...
	public static Vector3[] Sub(this Vector3[] lhs, Vector3[] rhs)
	{
		if (lhs.Length != rhs.Length)
		{
			Debug.Log("Incompatible array dimensions.");
	...
	public static float[] Sub(this float[] lhs, float[] rhs)
	{
		if (lhs.Length != rhs.Length)
		{
			Debug.Log("Incompatible array dimensions.");
	...
	public static Vector3[] Multiply(this Vector3[] vector, float constant)
	{
	...
	public static float[] Sub(this float[] lhs, float value)
	{
		float[] result = new float[lhs.Length];
		for (int i = 0; i < result.Length; i++)
		{
	...
	public static void Print<T>(this T[] values, bool inline = true, int newLineCnt = 0)
	{
		string output = string.Empty;
		for (int i = 0; i < values.Length; i++)
		{
			output += values[i].ToString() + (inline ? " " : "\n");
			if (newLineCnt > 1 && i != 0 && i % newLineCnt == 0)
				output += '\n';
		}
